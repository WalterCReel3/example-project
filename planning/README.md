...
| [2026-07-25-software-2d-sprites-tiling](2026-07-25-software-2d-sprites-tiling/) | `in-progress` | Where the handheld work goes: textures, atlases, TMX tilemaps, a minimal entity store. `util::xml`, `Texture` and the source-rect blit have landed, so the two gaps this snapshot named are closed. **`gfx::Atlas` is next**, and as of 2026-08-08 the Miyoo Mini's renderer no longer constrains it — source rects, blend and modulation all work there. The live constraint is its 640×480 texture cap |
