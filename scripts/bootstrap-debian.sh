...
PKGS_SDL=(
    ...
    #
    # GLU and GLEW are deliberately NOT here, and are no longer installed at all:
    # they existed only for the 2016 fixed-function backend, which is gone. SDL2's
    # own CMakeLists references neither.
    libgl1-mesa-dev
    libegl1-mesa-dev
    libgles-dev
    libegl-dev
